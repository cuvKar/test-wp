<?php
/**
 * The template for displaying the main site "Footer"
 *
 * @package     WordPress
 ...
 */
        ...
        /**
         * Triggers the cuv_2023_before_footer action hook
         * for components to render before the footer.
         *
         * @since 1.0.0
         */
        do_action('cuv_2023_before_footer'); ?>
        ...
        <footer id="page-footer" class="footer bg-white">
            <div class="container-fluid d-flex flex-column justify-content-between align-items-center">
				...
				$footer_menu_params = strip_tags(wp_nav_menu($footer_menu_params), '<a>');
				$footer_text = '"#" onclick="cookiefirst_show_settings()"';
				$footer_menu_params = str_replace( '"#cookie-policy"', $footer_text, $footer_menu_params );
				echo $footer_menu_params;
                ?>
                </nav>
                <nav class="footer-socials text-center">
                    ...
                    <a href="https://www.youtube.com/user/photoprotection">
                        <i class="fab fa-youtube fa-fw"></i>
                    </a>
                </nav>
                <p class="footer-colophon text-muted text-center">
                    &copy; <?php _e('CLINUVEL PHARMACEUTICALS LTD 2024.', 'cuvtwentythree'); ?> <span class="d-block d-sm-inline"><?php _e('All rights reserved.', 'cuvtwentythree'); ?></span><br>
                    <?php _e('To report suspected adverse reactions, contact CLINUVEL via <a href="mailto:safety@clinuvel.com">safety@clinuvel.com</a> ', 'cuvtwentythree'); ?>
                    <?php _e('or (US only) the FDA at 1-800-FDA-1088 or <a href="https://www.fda.gov/medwatch" target="_blank">www.fda.gov/medwatch</a>.', 'cuvtwentythree'); ?> 
                </p>
            </div>
        </footer>
        <!-- / footer -->
        ...
        <?php
        /**
         * Triggers the cuv_2023_after_footer action hook
         * for components to render after the footer.
         *
         * @since 1.0.0
         */
        do_action('cuv_2023_after_footer'); ?>
    ...
    <div id="site-menu" class="site-menu">
        <div class="site-menu-inner">
            ...
            wp_nav_menu([
                ...
                'menu_class'     => 'menu',
                'walker'         => new CUV_2023_Mega_Menu_Walker
            ]); ?> 
        </div>
    </div>
    <!-- / site-menu -->
    ...
    <a id="back-top" href="#" title="Scroll to top" class="btn fw-semibold text-uppercase text-white border-black">
        ...
        <?php _e('Go To Top', 'cuvtwentythree'); ?> 
    </a>
    <!-- / back-top -->

    <?php 
    $popup_modal = get_field('popup_modal');
    if ($popup_modal && $popup_modal['display']) {
    ?> 
    <!-- Modal -->
    <div class="modal fade" id="popup-modal" tabindex="-1" aria-labelledby="popup-modal-label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <?php if ($popup_modal['title']) { ?> 
                <div class="modal-header">
                    <h1 class="modal-title display-3" id="popup-modal-label">Modal title</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <?php } ?> 
                <?php if ($popup_modal['text']) { ?> 
                <div class="modal-body text-center display-3 fw-normal">
                    <?php echo nl2br($popup_modal['text']); ?> 
                </div>
                <?php } ?> 
                <div class="modal-footer justify-content-center">
                    <?php if ($popup_modal['button']) { ?> 
                    <a href="<?php echo esc_url($popup_modal['button']['link']); ?>" role="button" class="btn btn-outline-dark fw-semibold text-uppercase lh-1 display-4 me-3">
                        <?php echo $popup_modal['button']['text']; ?> 
                    </a>
                    <?php } ?> 
					<button type="button" class="btn btn-outline-dark fw-semibold text-uppercase lh-1 display-4 ms-3" data-bs-dismiss="modal">
                        <?php echo $popup_modal['close_text']; ?> 
                    </button>
                </div>
            </div>
        </div>
